    ...
    <div>
      <div class="brand-logo d-flex align-items-center justify-content-between">
        <a href="/" class="text-nowrap logo-img">
          ...
          <img
            src="{{asset('dist/images/logos/logo-1.png')}}"
            class="dark-logo" width="200" alt="" />
        </a>
      ...
      <nav class="sidebar-nav scroll-sidebar" data-simplebar>
        <ul id="sidebarnav">
          ...
          <li class="sidebar-item">
            <a class="sidebar-link" href="/berita " aria-expanded="false">
              <span>
      ...
      <div class="fixed-profile p-3 bg-light-secondary rounded sidebar-ad mt-3">
        <div class="hstack gap-3">
          <div class="john-img">
            <img src="../../dists/images/profile/user-1.jpg" class="rounded-circle" width="40" height="40" alt="">
          </div>
