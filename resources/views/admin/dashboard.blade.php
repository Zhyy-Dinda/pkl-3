                ...
                <div class="card bg-light-primary shadow-none">
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex align-items-center justify-content-between mt-4">
                            <h3 class="mb-0 fw-semibold fs-7">Top - {{$data->count()}}</h3>
                            <span class="fw-bold">kamuuuuu</span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-4 ">
                                <div class="card shadow-sm overflow-hidden border card-hover mb-4 mb-md-0">
                                    <img src="{{ Storage::url('public/berita/') . $dt->image }}" style="height: 150px" alt="img" />
                                    <div class="card-body p-4">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div>
                                                <h6 class="mb-0 fs-5 fw-semibold">{{$dt->title}}</h6>
                                                {{-- <span>els@email</span> --}}
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-start justify-content-between mt-3">
                                            ...
                                            <div class="text-end">
                                                ...
                                                <span class="fs-3">{{$dt->created_at}}</span>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-start justify-content-between mt-3">
                                            <span>
                                                <i class="ti ti-clock-hour-4 me-1 fs-4"></i>{{$dt->info}}</span>
                                            <span>
